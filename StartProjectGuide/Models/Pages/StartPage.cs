...
namespace StartProjectGuide.Models.Pages
{
    ...
    [AvailableContentTypes(
        ...
        Include = new[] { typeof(FindSearchPage), typeof(ServiceLandingPage), typeof(WorkLandingPage), typeof(ContactLandingPage), typeof(StandardPage), typeof(LandingPage), typeof(ContentFolder) }, // Pages we can create under the start page...
        ExcludeOn = new[] { typeof(FindSearchPage), typeof(ServiceLandingPage), typeof(WorkLandingPage), typeof(ContactLandingPage), typeof(StandardPage), typeof(LandingPage) })] // ...and underneath those we can't create additional start pages
